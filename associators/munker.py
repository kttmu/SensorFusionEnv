...
20210730 m201209 commented:"AS IS" code in https://github.com/bmc/munkres
"""
        ...
        **Returns**
        ...
        for i in range(self.original_length):
            for j in range(self.original_width):
                #20210820 rewrite, delete same object
                if self.marked[i][j] == 1 and (i != j):
                    results += [(i, j)]
...
if __name__ == '__main__':
    ...
    m = Munkres()
    import numpy as np
    cost = np.array([[5,4,7,6],[6,7,3,2],[8,11,2,5],[9,8,6,7]])
